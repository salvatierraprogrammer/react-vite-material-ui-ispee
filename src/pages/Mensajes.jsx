...
import { Send, Search, Close, ChatOutlined } from '@mui/icons-material'
...
export default function Mensajes() {
  ...
  return (
    <Box sx={{ display: 'flex', height: 'calc(100vh - 104px)', gap: 1.5 }}>
      <Paper sx={{ width: 280, flexShrink: 0, display: { xs: 'none', sm: 'flex' }, flexDirection: 'column', borderRadius: '12px', overflow: 'hidden' }}>
        <Box sx={{ p: 1.5, pb: 0 }}>
